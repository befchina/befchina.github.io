...
![Figure]({{ site.baseurl }}/assets/projects/WMQ-2026-NC2-1.jpg)
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 1. Conceptual figure illustrating the processes determining stability across levels of organization within 
and across trophic levels. 
</span></p>


![Figure]({{ site.baseurl }}/assets/projects/WMQ-2026-NC2-2.jpg)
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 2. Pathways of stability determining processes within and across trophic levels based on structural 
equation model results.
</span></p>


![Figure]({{ site.baseurl }}/assets/projects/WMQ-2026-NC2-3.jpg)
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 3. Summary of the interactive effects of plant and herbivore species diversity on stability across levels 
of organization from structural equation model. 
</span></p>
