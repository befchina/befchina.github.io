...
author: Georg Albert
categories: [ Paper ]
image: assets/projects/Albert-NC-0.png
tags: featured
---
...
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 1. Overview of species interaction networks, ecosystem functions, and network indices.
</span></p>


![Figure]({{ site.baseurl }}/assets/projects/YZ-EL-2.png)
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 2.  Network structure mediates the effect of tree species richness on ecosystem multifunctionality in (a) antagonistic and (b) mutualistic interaction networks.
</span></p>


![Figure]({{ site.baseurl }}/assets/projects/YZ-EL-3.png)
<p style='text-align: justify;' ><span style="font-style: italic; font-size:70%">Figure 3.  Effects of tree species richness and network size (as a measure of multitrophic diversity) on ecosystem multifunctionality (EMF).
</span></p>
